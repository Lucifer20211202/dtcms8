<template>
	<div class="mainbody">
		<dt-location :data="[{title:'会员管理'},{title:'会员列表'}]"></dt-location>
		<dt-toolbar-box>
			<template #default>
				<div class="list-box">
					<div class="l-list">
						<el-button-group>
							<el-button icon="Plus" @click="$common.linkUrl('/member/edit')">新增</el-button>
		...
		<div class="content-box">
			<el-card class="table-card">
				<el-table ref="tableRef" v-loading="datas.loading" :data="datas.listData" stripe class="table-list" @selection-change="handleSelectionChange">
					...
					<el-table-column label="用户名" min-width="155">
						<template #default="scope">
							<h4>
								{{scope.row.userName}}
					...
					<el-table-column fixed="right" label="操作" width="90">
						<template #default="scope">
							<el-button size="small" icon="Edit" @click="$common.linkUrl(`/member/edit/${scope.row.userId}`)"></el-button>
...
<script setup>
	...
	const initData = async() => {
		let sendUrl = `/admin/member?pageSize=${datas.pageSize}&pageIndex=${datas.pageIndex}`
